            ...
            <div className={SignupStyles.SignupDiv}>
                ...
                <div>
                    <form className={SignupStyles.FormBox}>
                        ...
                        <div className={SignupStyles.InputBox}>
                            <label style={{fontSize:"20px",fontWeight:"600"}} htmlFor="name">Type</label>
                            <Select name="type" value={type} onChange={(e)=>(handleChange(e))} placeholder="Select the type of account" >
